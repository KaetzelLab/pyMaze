...
class Settings_dialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # Create widgets.
        self.s_len_label = QtWidgets.QLabel('State history length')
        self.s_len_text  = QtWidgets.QLineEdit(str(100))
        self.e_len_label = QtWidgets.QLabel('Event hisory length')
        self.e_len_text  = QtWidgets.QLineEdit(str(100))
        self.a_len_label = QtWidgets.QLabel('Analog history duration (s)')
        self.a_len_text  = QtWidgets.QLineEdit(str(5))
        # Layout
