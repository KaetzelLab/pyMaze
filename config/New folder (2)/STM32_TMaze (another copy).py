...
### RewardRecepttacle
home_reward_rec = Digital_input(pin=board.limit_1_bot, falling_event='homeRewardPoke_in', rising_event='homeRewardPoke_out')
left_reward_rec = Digital_input(pin=board.limit_2_bot, falling_event='leftRewardPoke_in', rising_event='leftRewardPoke_out')
right_reward_rec = Digital_input(pin=board.limit_3_bot, falling_event='rightRewardPoke_in', rising_event='rightRewardPoke_out')
