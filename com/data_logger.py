...
class Data_logger():
    ...
    def open_data_file(self, data_dir, experiment_name, experimenter_name, subject_ID, subject_group,
                       subject_subgroup, datetime_now=None):
        ...
        self.data_file.write('I Experimenter name  : {}\n'.format(self.experimenter_name))
        self.data_file.write('I Task name : {}\n'.format(self.sm_info['name']))
        self.data_file.write('I Subject ID : {}\n'.format(self.subject_ID))
        self.data_file.write('I Subject Group : {}\n'.format(self.subject_group))
        self.data_file.write('I Subject Subgroup : {}\n'.format(self.subject_subgroup))
